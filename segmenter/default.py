...
def Bigram_Jelinek(word,pred):
    ...
    unigram_prob= float(0.9999999999)*unigram_count/float(N) +float(0.0000000001)*(float(0.1)/float(N))
    if pred==None:
    ...
    if bigram_count!=0:
        ...
        return numpy.logaddexp2(math.log(0.8,2)+bigram_prob,math.log(0.1,2)+unigram_log_prob)
    else:
        return math.log(float(0.1)*unigram_prob,2)
